 ...
 *      1. include slug.php
 *      2. create a new SLUG object: "$slug = new \BiStorm\SLUG\Slug('bistorm', $app_init_array, false);"
 ...
 *              'exec_type': Accepts 'sh', 'bash', 'py', 'ruby', or 'npm'
 *          ]
 * 
...
class Slug {
     ...
     * @return boolean|\BiStorm\SLUG\Exception
     * @throws Exception
     */
    public function __construct($slugfile = '/slug/slug.json', $namespace = "bistorm", $app_init = array(), $response_yn = false){ 
     ...
     * @param type $exec_type  Accepts 'sh', 'bash', 'py', 'ruby', 'npm'
     */
